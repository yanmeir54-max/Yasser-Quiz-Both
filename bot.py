...
async def get_ultra_smart_options(question_text, category_name, correct_ans):
    try:
        ...
        # 1️⃣ [ مصفوفة الموسوعة العالمية الشاملة - نسخة 2026 النهائية ] 🌐
        # تم تصميمها لتشمل كل الأنماط الممكنة على وجه الأرض
        patterns = {
            # التاريخ والزمن
            'history_dates': ['عام', 'سنه', 'تاريخ', 'قرن', 'ميلادي', 'هجري', 'معركه', 'غزوه', 'ثوره', 'حضاره', 'امبراطور', 'ملك'],
            
            # الجغرافيا والكون
            'geography_world': ['دوله', 'بلد', 'عاصمه', 'مدينه', 'نهر', 'بحر', 'محيط', 'جبل', 'قاره', 'جزيره', 'خليج', 'مضيق', 'مناخ', 'تضاريس'],
            
            # العلوم والطب والطبيعة
            'science_tech': ['كوكب', 'عنصر', 'غاز', 'حيوان', 'طائر', 'نبات', 'جسم', 'خليه', 'جهاز', 'مخترع', 'اكتشف', 'فيزياء', 'كيمياء', 'مجره', 'فضاء'],
            'medical_anatomy': ['عضو', 'مرض', 'دواء', 'فيتامين', 'هرمون', 'عصب', 'عظم', 'دم', 'قلب', 'دماغ'],
            
            # الشخصيات والأدب والفنون
            'humanities': ['من هو', 'الشاعر', 'مؤلف', 'كاتب', 'فنان', 'رسام', 'فيلسوف', 'رواية', 'قصيدة', 'لوحة', 'تمثال'],
            'islamic_world': ['سوره', 'آيه', 'نبي', 'رسول', 'الصحابي', 'تابعي', 'فقيه', 'كتاب', 'تفسير', 'حديث', 'صلاة', 'حج'],
            
            # الرياضة والترفيه
            'sports_ent': ['لاعب', 'نادي', 'منتخب', 'بطوله', 'كاس', 'ملعب', 'هدف', 'اولمبياد', 'فيلم', 'مسلسل', 'ممثل', 'مخرج', 'اغنية'],
            
            # الرياضيات والمنطق والأرقام
            'math_logic': ['حساب', 'رياضيات', 'مربع', 'مثلث', 'زاويه', 'مجموع', 'ناتج', 'معادله', 'رقم', 'ضعف', 'جذر'],
            'measurements': ['كم عدد', 'كم يبلغ', 'ما طول', 'ما وزن', 'نسبه', 'مسافه', 'الوحده', 'لقياس', 'مادة', 'الزمن', 'سرعه', 'درجه'],
            
            # اللغة والأمثال والعامة
            'language_proverbs': ['مرادف', 'ضد', 'معنى', 'جمع', 'مفرد', 'مثل', 'حكمه', 'قائل', 'كلمة', 'لغة', 'لهجة'],
            'food_brands': ['اكله', 'وجبه', 'مطبخ', 'فاكهه', 'خضار', 'سياره', 'ماركه', 'شركه', 'شعار', 'هاتف', 'تطبيق']
        }
